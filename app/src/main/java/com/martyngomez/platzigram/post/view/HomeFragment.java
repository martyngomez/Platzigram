...
public class HomeFragment extends Fragment {
    ...
    private void takePicture() {
        ...
        if(intentTakePicture.resolveActivity(getActivity().getPackageManager())!= null)  { //Valida la existencia de una camara
            ...
            if (photoFile != null){
                String packageName = getActivity().getApplicationContext().getPackageName(); //Obetern package //"com.martyngomez.platzigram"
                Uri photoUri = FileProvider.getUriForFile(getActivity(),packageName, photoFile ); //Obtiene Uri de la foto
